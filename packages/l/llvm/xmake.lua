...
package("llvm")
    ...
    add_configs("clang",             {description = "Enable clang project.", default = false, type = "boolean"})
    ...
    add_configs("compiler-rt",       {description = "Enable compiler-rt project.", default = false, type = "boolean"})
    ...
    add_configs("libcxx",            {description = "Enable libcxx runtime.", default = false, type = "boolean"})
    add_configs("libcxxabi",         {description = "Enable libcxxabi runtime.", default = false, type = "boolean"})
