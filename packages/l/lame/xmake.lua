-- from: https://github.com/xmake-io/xmake-repo/blob/master/packages/l/lame/xmake.lua

--- make shared option writable.
...
package("lame")
    ...
    add_configs("shared", {description = "Build static libraries", default = false, type = "boolean"})
